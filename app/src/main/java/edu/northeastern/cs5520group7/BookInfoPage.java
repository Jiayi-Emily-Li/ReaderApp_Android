...
public class BookInfoPage extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addBookmark() {
        ...
        Toast.makeText(this, titleTV.getText().toString() + "has successfully added to your book list", Toast.LENGTH_SHORT).show();
    }
    ...
    private void removeBookmark() {
        ...
        Toast.makeText(this, titleTV.getText().toString() + "has successfully removed from your book list", Toast.LENGTH_SHORT).show();
    }
