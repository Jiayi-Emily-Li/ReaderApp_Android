...
public interface HTTPController {
    ...
    @GET("/books/v1/volumes")
    Call<MultiBooks> getCategoryResults(@Query(value = "q") String searchText, @Query("filter") String filter, @Query("orderBy") String orderBy, @Query("maxResults") int maxResults);
